"""
Script para procesar videos y extraer landmarks
...
def process_videos_from_directory(
    ...
    """
    Procesa todos los videos en un directorio y guarda los landmarks.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Procesa videos y extrae landmarks usando MediaPipe"
    )
    parser.add_argument(
        "--input",
        type=str,
